/**
 * Cloudflare Pages Function (Node-like runtime) to handle recipe generation.
 *
 * This file will be deployed in the `/functions` directory of a Cloudflare Pages
 * project. The function will be accessible under the `/api/generate` path.
 * It accepts a JSON payload with coffee details, constructs a structured
 * prompt, forwards the request to the OpenAI API, and returns the resulting
 * HTML block from the model. The OpenAI API key is provided via a secret
 * environment variable defined in the Cloudflare dashboard.
 */
